// Generated on 2015-03-14 using generator-php 0.4.0
'use strict';
        ...
        php: {
            server: {  //Configuration options for the "server" task (i.e. during development).
                options: {
                    ...
                    port: '<%= yeoman.devPort %>',
                    base: '<%= yeoman.app %>/public', //Set the document root to the app folder.
                }
            },
            dist: { // The "server" task can pass in a "dist" arguement. Configure the server accordingly.
                options: {
                    ...
                    hostname: '<%= yeoman.devURL %>',
                    port: '<%= yeoman.devPort %>',
                    base: '<%= yeoman.dist %>/public', //Set the document root to the dist folder.
                    open: true
                }
            }
        },
